...
data modify entity @s[nbt=!{Item:{tag:{arcane_eye:1b}}}] Item.tag.Enchantments append value {}
data modify entity @s[nbt=!{Item:{tag:{arcane_eye:1b}}}] Item.tag.display.Lore prepend value "[{\"text\":\"Arcane Eye\",\"italic\":false,\"color\":\"gray\"}]"
data modify entity @s[nbt=!{Item:{tag:{arcane_eye:1b}}}] Item.tag.customEnchanting.Tags append value "arcane_eye"
data modify entity @s[nbt=!{Item:{tag:{arcane_eye:1b}}}] Item.tag.arcane_eye set value 1b
...
tag @s remove arcane_eye_charging