...
data modify entity @s[nbt=!{Item:{tag:{precise_shot:1b}}}] Item.tag.Enchantments append value {}
data modify entity @s[nbt=!{Item:{tag:{precise_shot:1b}}}] Item.tag.display.Lore prepend value "[{\"text\":\"Precise Shot\",\"italic\":false,\"color\":\"gray\"}]"
data modify entity @s[nbt=!{Item:{tag:{precise_shot:1b}}}] Item.tag.customEnchanting.Tags append value "precise_shot"
data modify entity @s[nbt=!{Item:{tag:{precise_shot:1b}}}] Item.tag.precise_shot set value 1b
...
tag @s remove precise_shot_charging