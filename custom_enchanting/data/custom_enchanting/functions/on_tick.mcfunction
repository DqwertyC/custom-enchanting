...
# Apply enchants to arrows
execute as @e[type=arrow,tag=!bow_checked] run function custom_enchanting:enchant_arrow
execute as @e[type=spectral_arrow,tag=!bow_checked] run function custom_enchanting:enchant_arrow
