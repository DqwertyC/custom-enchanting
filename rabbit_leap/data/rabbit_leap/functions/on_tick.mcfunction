...
execute as @a[scores={rabbit_leap_lvl=2..,rabbit_sneak=30}] at @s run playsound minecraft:block.note_block.harp neutral @s ~ ~ ~ 1 1.0
execute as @a[scores={rabbit_leap_lvl=2..,rabbit_sneak=30}] at @s run playsound minecraft:block.note_block.harp neutral @s ~ ~ ~ 1 0.5

execute as @a[scores={rabbit_leap_lvl=3..,rabbit_sneak=50}] at @s run playsound minecraft:block.note_block.harp neutral @s ~ ~ ~ 1 1.4
execute as @a[scores={rabbit_leap_lvl=3..,rabbit_sneak=50}] at @s run playsound minecraft:block.note_block.harp neutral @s ~ ~ ~ 1 0.7

effect give @a[scores={rabbit_leap_lvl=1..,rabbit_sneak=10..}] minecraft:jump_boost 1 0 true
effect give @a[scores={rabbit_leap_lvl=2..,rabbit_sneak=30..}] minecraft:jump_boost 1 2 true
effect give @a[scores={rabbit_leap_lvl=3..,rabbit_sneak=50..}] minecraft:jump_boost 1 4 true
